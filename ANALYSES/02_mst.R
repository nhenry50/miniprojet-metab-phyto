...
sequences <- read.FASTA("outputs/crypto_seq_unique_alligned.fasta")
...
crypto_mst <- data.table(crypto_mst,keep.rownames = TRUE) |>
  melt(na.rm=TRUE,id.vars="rn")
# rename the table
